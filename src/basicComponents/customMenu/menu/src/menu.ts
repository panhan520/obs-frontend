...
import type { PopperEffect } from 'element-plus'
...
export default defineComponent({
  ...
  setup(props, { emit, slots, expose }) {
    ...
    const menuRef = ref<HTMLUListElement>() // 菜单
    ...
    const activeIndex = ref<MenuProvider['activeIndex']>(props.defaultActive) // 选中下标
